...
with col2:
    ...
    if "prediction_made" in st.session_state:
        ...
        confidence = (
            st.session_state.prediction_proba[st.session_state.prediction] * 100
        )
...
tab1, tab2, tab3 = st.tabs(
    ["📊 Dataset Overview", "📈 Feature Distribution", "🔗 Correlation Matrix"]
)
...
with tab2:
    ...
    feature_to_plot = st.selectbox("Select feature to visualize:", iris.feature_names)
    ...
    fig_dist.update_layout(height=500, template="plotly_white", showlegend=True)
